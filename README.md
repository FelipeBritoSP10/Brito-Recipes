...
O **Brito Recipes** é uma interface moderna e imersiva projetada para a descoberta de experiências culinárias de alto padrão 🥂. O projeto rompe com o visual tradicional de sites de culinária, adotando uma estética Cyber-Luxury baseada em neon, glassmorphism e tipografia vanguardista.
...
- HTML5 & CSS3: Estrutura semântica e estilização avançada 🏗️

- Tailwind CSS: Framework utilitário para agilidade e consistência no layout 🎨

- JavaScript (Vanilla): Lógica pura para manipulação de DOM e consumo de API ⚡

- TheMealDB API: O motor de dados oficial por trás das receitas globais 🌍

- Google Fonts: Integração das famílias tipográficas premium 🆒

# 🚀 Como Executar o Projeto

```bash
# Clone o repositório
git clone https://github.com/FelipeBritoSP10/Brito-Recipes
